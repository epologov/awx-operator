...
sed -i.bak -e "s|containerImage: amr-registry.caas.intel.com/it-lab-ops/awx-operator:devel|containerImage: ${OPERATOR_IMG}|g" bundle/manifests/awx-operator.clusterserviceversion.yaml
